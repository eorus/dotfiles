...
- OS : Arch Linux
- WM : [i3gaps](https://www.archlinux.org/packages/community/x86_64/i3-gaps/)
...
- Image Editors : Vimiv-Qt, imagemagick, gthumb
...
- [picom](https://wiki.archlinux.org/index.php/Picom) to enable opacity
- [mpc](https://www.archlinux.org/packages/?name=mpc) to make media keys work with mpd
- [nm-applet](https://www.archlinux.org/packages/?name=network-manager-applet) for network management
